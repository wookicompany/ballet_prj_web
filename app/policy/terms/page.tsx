...
const TERMS = [
  ...
  },
  {
    title: "제2조 (정의)",
    content:
      "‘서비스’란 회사가 제공하는 발레 기록 및 캘린더 관리, 공연 정보 조회, 리뷰·댓글 작성, 신고, 문의하기, 알림, 운동 데이터 연동 기능과 그에 부수하는 서비스를 말합니다.",
  },
  {
  ...
  },
  {
    title: "제9조 (책임 제한)",
    content:
      "회사는 천재지변, 불가항력 등 회사의 책임 없는 사유로 서비스를 제공할 수 없는 경우 책임을 지지 않습니다. 외부 데이터 제공처 또는 플랫폼 연동 과정에서 발생한 지연, 누락, 정확도 이슈에 대해서도 회사의 고의 또는 중대한 과실이 없는 한 책임이 제한됩니다.",
  },
  {
    title: "제10조 (분쟁 해결)",
    content:
