...
const PRIVACY_ITEMS = [
  {
    ...
    content:
      "계정 정보(이메일), 프로필 정보(닉네임, 프로필 이미지), 기록 정보(날짜/시간/내용/기분/사진/장소), 커뮤니티 이용 정보(리뷰/댓글/좋아요/신고), 브랜드 이용 정보(찜하기, 링크 클릭, 조회), 문의 접수 정보(답변 이메일, 제목, 내용, 닉네임), 푸시 알림 토큰(expo_push_token), 앱 플랫폼 정보(iOS/Android), 운동 동기화 정보(활동명, 기기/소스 정보, 칼로리, 심박수)를 수집할 수 있습니다.",
  },
  {
    title: "2. 수집 및 이용 목적",
    content:
      "서비스 제공 및 운영, 이용자 식별과 인증, 기록 보관, 리뷰/댓글 등 커뮤니티 운영, 브랜드 서비스 제공(찜하기·링크 클릭·조회 기능), 신고 처리, 고객 문의 답변, 푸시 알림 발송, 플랫폼별 기능 제공, 운동 데이터 연동 기능 제공을 위해 개인정보를 이용합니다.",
  },
  {
    title: "3. 보유 및 이용 기간",
    content:
  ...
  return (
    <MobileContainer>
      <main className="px-4 pb-12">
        <PageHeader title="개인정보 처리방침" className="mb-6" />
