...
const PRIVACY_ITEMS = [
  {
    ...
    content:
      "계정 정보(이메일), 프로필 정보(닉네임, 프로필 이미지), 기록 정보(날짜/시간/내용/기분/사진), 커뮤니티 이용 정보(리뷰/댓글/좋아요/신고), 문의 접수 정보(답변 이메일, 제목, 내용, 닉네임)를 수집합니다.",
  },
  {
    title: "2. 수집 및 이용 목적",
    content:
      "서비스 제공 및 운영, 이용자 식별과 인증, 기록 보관, 리뷰/댓글 등 커뮤니티 운영, 신고 처리, 고객 문의 답변을 위해 개인정보를 이용합니다.",
  },
  {
    title: "3. 보유 및 이용 기간",
    content:
      "회원 탈퇴 시 관련 데이터는 즉시 소프트 삭제 처리되며, 소프트 삭제일로부터 30일이 지난 데이터는 하드 삭제합니다. 다만 문의 내역은 분쟁 대응 및 서비스 품질 개선을 위해 일정 기간 보관할 수 있으며, 관련 법령에 따라 보관이 필요한 경우에는 해당 법령에서 정한 기간 동안 보관합니다.",
  },
  {
    title: "4. 제3자 제공",
    content:
  ...
  },
  {
    title: "5. 처리 위탁",
    content:
      "서비스 운영을 위해 클라우드/SaaS(예: Supabase, Vercel) 및 소셜 로그인 제공자(카카오, 구글, 애플)를 이용할 수 있으며, 위탁 또는 제공 관계가 변경될 경우 관련 사실을 안내합니다.",
  },
  {
    title: "6. 이용자 권리",
    content:
